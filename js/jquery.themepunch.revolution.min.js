...
(function (e, t) {
    ...
    function r(n, i) {
        ...
        if (e(window).width() < i.hideSliderAtLimit) {
            ...
            if (n.is(":hidden")) {
                if (o.data("olddisplay") != t && o.data("olddisplay") != "undefined" && o.data("olddisplay") != "none") o.css({ display: o.data("olddisplay") });
    ...
    function C(e, n) {
        ...
        if (u.data("lazyload") != t && u.data("lazyload") != "undefined" && u.data("lazydone") != 1) {
            if (!o(8)) u.css({ backgroundImage: 'url("' + s.find(".defaultimg").data("lazyload") + '")' });
            else {
    ...
    function L(n, r) {
        ...
        if (l == 4 || l == 5) {
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.to(n, A * 3, { transformPerspective: 600, top: 0 + r.height, opacity: 0.5, rotation: r.rotate, ease: Power2.easeInOut, delay: i });
            });
            f.find(".slotslide").each(function (t) {
                var s = e(this);
                var o = (t * A) / r.slots;
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            if (d != 1) {
                if (l == 12) TweenLite.to($, V, { left: 0 - P + "px", scale: R, opacity: I, rotation: r.rotate, ease: z });
                ...
                else if (l == 14) TweenLite.to($, V, { top: H + "px", scale: R, opacity: I, rotation: r.rotate, ease: z });
            }
            u.css({ opacity: 1 });
        }
        if (l == 16) {
            ...
            TweenLite.fromTo(
                i.find(".tp-half-one"),
                N / 1e3,
                { width: P, height: H / 2, position: "absolute", top: "0px", left: "0px", transformPerspective: 600, transformOrigin: "center top" },
            ...
            TweenLite.fromTo(
                i.find(".tp-half-two"),
                N / 1e3,
                { width: P, height: H, overflow: "hidden", position: "absolute", top: H / 2, left: "0px", transformPerspective: 600, transformOrigin: "center bottom" },
            ...
            if (i.html() != null)
                TweenLite.fromTo(
                    u,
                    (N - 200) / 1e3,
                    { opacity: 0, scale: 0.8, x: r.width * et, y: H * tt, rotation: Z, transformPerspective: 600, transformOrigin: "center center" },
        ...
        if (l == 19 || l == 22) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1e3,
                    { left: 0, rotationY: r.rotate, opacity: I, top: 0, scale: 0.8, transformPerspective: 600, transformOrigin: ut, rotationX: ot },
                    {
                        left: 0,
                        rotationY: 0,
                        opacity: 1,
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1e3,
                    { opacity: 1, rotationY: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationX: 0 },
                    {
                        opacity: 1,
                        rotationY: r.rotate,
                        top: 0,
        ...
        if (l == 20) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1e3,
                    { rotationX: 40, z: -600, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot },
                    {
                        rotationX: 0,
                        opacity: 1,
                        top: 0,
        ...
        if (l == 21 || l == 25) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1500,
                    { left: 0, rotationX: rot2, z: 0, opacity: 0, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot },
                    {
                        left: 0,
                        rotationX: 0,
                        top: 0,
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    n,
                    N / 3e3,
                    { left: 0, rotationX: 0, z: 0, opacity: 1, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: 0 },
                    { left: 0, rotationX: rot2, top: 0, z: 0, scale: 1, rotationY: ot, delay: (t * 100) / 1e3, ease: Power1.easeInOut }
                );
        ...
        if (l == 23 || l == 24) {
            ...
            f.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1e3,
                    { left: ft, rotationX: r.rotate, opacity: I, top: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: ot },
                    {
                        left: 0,
                        rotationX: 0,
                        opacity: 1,
            ...
            a.find(".slotslide").each(function (t) {
                ...
                TweenLite.fromTo(
                    s,
                    N / 1e3,
                    { left: 0, opacity: 1, rotationX: 0, top: 0, z: 0, scale: 1, transformPerspective: 600, transformOrigin: ut, rotationY: 0 },
                    {
                        left: ft,
                        opacity: 1,
                        rotationX: r.rotate,
        ...
        l.find(".defaultimg").each(function () {
            ...
            t.data(
                ...
                TweenLite.fromTo(
                    n,
                    w,
                    { autoAlpha: 1, transformPerspective: 1200, transformOrigin: "0% 0%", top: 0, left: 0, scale: i.w, x: i.x, y: i.y },
                    {
                        autoAlpha: 1,
                        rotationZ: m,
                        ease: b,
                ...
                if (!i) {
                    ...
                    if (a != 2) {
                        if (f.hasClass("customin")) {
                            if (I != f)
                                F.add(TweenLite.set(f, { opacity: 1, scaleX: 1, scaleY: 1, rotationX: 0, rotationY: 0, rotationZ: 0, skewX: 0, skewY: 0, z: 0, x: 0, y: 0, visibility: "visible", opacity: 1, delay: 0, overwrite: "all" }));
                            q.visibility = "hidden";
                                ...
                                new TweenLite.fromTo(
                                    ...
                                    { a: 360 },
                                    {
                                        ...
                                        onUpdate: function () {
                                            ...
                                            TweenLite.to(u.element, 0.1, { x: Math.cos(e) * u.unit, y: u.unit * (1 - Math.sin(e)) });
                                        },
                                        onComplete: function () {
                                            n.data("timeline").restart();
                                        },
        ...
        g = function (e, t, n, r, u) {
            ...
            if (k || O)
                for (d = 0; U > d; d++)
                    (b = y[d]),
                        ...
                        (l || O || (A && !L)) &&
                        ((w = b.offsetTop),
                            k && l && w !== _ && "BR" !== b.nodeName && ((f = []), k.push(f), (_ = w)),
                            O && ((b._x = b.offsetLeft), (b._y = w), (b._w = b.offsetWidth), (b._h = b.offsetHeight)),
                            k && ((L !== l && A) || (f.push(b), (b._x -= P)), l && d && (y[d - 1]._wordEnd = !0)));
            for (d = 0; U > d; d++)
                (b = y[d]),
                    (l = b.parentNode === e),
                    "BR" !== b.nodeName
                        ? (O &&
                            ((S = b.style),
                                L || l || ((b._x += b.parentNode._x), (b._y += b.parentNode._y)),
                                (S.left = b._x + "px"),
                                (S.top = b._y + "px"),
                                (S.position = "absolute"),
                                (S.display = "block"),
                                (S.width = b._w + 1 + "px"),
                                (S.height = b._h + "px")),
                            L ? (l ? r.push(b) : A && n.push(b)) : l ? (e.removeChild(b), y.splice(d--, 1), U--) : !l && A && ((w = !k && !O && b.nextSibling), e.appendChild(b), w || e.appendChild(s.createTextNode(" ")), n.push(b)))
                        : k || O
            ...
            if (k) {
                ...
                for (T = !O || (!L && !A), d = 0; k.length > d; d++) {
                    for (
                        f = k[d], E = s.createElement("div"), E.style.cssText = "display:block;text-align:" + I + ";position:" + (O ? "absolute;" : "relative;"), $ && (E.className = $ + (V ? d + 1 : "")), u.push(E), U = f.length, m = 0;
                        U > m;
                        m++
                    )
                        "BR" !== f[m].nodeName &&
                            ((b = f[m]),
                                ...
                                O && (0 === m && ((E.style.top = b._y + "px"), (E.style.left = P + w + "px")), (b.style.top = "0px"), w && (b.style.left = b._x - w + "px")));
